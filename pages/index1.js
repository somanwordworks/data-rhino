...
export async function getStaticProps() {
    ...
    return { props: { airtableData, rssData, adsData, meetupEvents, webinars }, revalidate: 21600 };
}
            ...
            <div className="flex w-full">
                ...
                <div className="w-full main-scroll-container relative">
                    ...
                    <div className="py-10 bg-white border-t border-gray-200">
                        ...
                        </div> {/* ✅ closes grid div inside Clientele */}
                    </div> {/* ✅ closes Clientele section */}
